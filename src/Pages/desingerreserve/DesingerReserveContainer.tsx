...
import DesignerReservePresentation from './DesingerReservePresentation';

// 초기 예약 데이터 예시
const initialDesignerReservations: Reservation[] = [
...
const DesignerReserveContainer = () => {
  const [reservations, setReservations] = useState<Reservation[]>(initialDesignerReservations);
